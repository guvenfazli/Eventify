  ...
  return (
    <div className="flex flex-col items-start justify-start text-[#2D2C3C] font-opensans">
      ...
      <div className="flex items-center justify-start gap-3">
        ...
        <p className="font-semibold text-[24px]">Ticket Type: {multiStepValues.eventType} / {multiStepValues.ticketPrice} x <span className="text-[20px]">{multiStepValues.ticketQuantity} EUR</span></p>
      </div>
    </div>
  )
}