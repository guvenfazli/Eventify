...
export default function SearchBarAndSelectOptions() {
  ...
  return (
    <div className="flex items-center justify-center z-10 max-h-[72px] w-full">
      <div className="flex w-1/2 relative items-center">
        <FiSearch className="absolute text-4xl text-[#5A5A5A] left-4 hover:cursor-pointer" />
        <input className="w-full pr-3 pl-16 py-5 outline-none font-monster text-[20px] rounded-tl-lg rounded-bl-lg" placeholder={`${srch ? srch : "Search Events, Categories, Locations..."}`} value={srch && srch} />
